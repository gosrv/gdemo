...
public void ClearDirty() {
        ...
        if (this.isDirtychapter)
        {
            this.isDirtychapter = false; 
                this.chapter.ClearDirty();
        }
...
public class Chapter {
        ...
        public bool isDirtyheros { get; private set; }
            public int level { get; private set; }
        public bool isDirtylevel { get; private set; }
            public long prizeCheckTime { get; private set; }
        public bool isDirtyprizeCheckTime { get; private set; }
...
public void ClearDirty() {
        ...
        if (this.isDirtyprizeCheckTime)
        {
            this.isDirtyprizeCheckTime = false;
        }
